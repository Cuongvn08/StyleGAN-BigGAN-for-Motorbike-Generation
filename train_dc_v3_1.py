...
class Config():
    ...
    PATH_PRETRAINED_G = '/data/cuong/result/motobike/dc_v3/492_G.pth'.format(MODEL_NAME)
    PATH_PRETRAINED_D = '/data/cuong/result/motobike/dc_v3/492_D.pth'.format(MODEL_NAME)
