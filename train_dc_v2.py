...
class Config():
    ...
    PATH_PRETRAINED_G = '/data/cuong/result/motobike/dcgan/126_generator.pth'
    PATH_PRETRAINED_D = '/data/cuong/result/motobike/dcgan/126_discriminator.pth'
...
def generate_images(model_path, dir_images_output, num_images=10000, batch_size=1000):
    ...
    for batch in range(int(num_images/batch_size)):
        printBoth(Config.LOG, 'Generating batch {}'.format(batch))
